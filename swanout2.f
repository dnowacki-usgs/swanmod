...
!NCF      SUBROUTINE SWTABP (RTYPE , OQI  , OQR , IVTYP, PSNAME, MIP, VOQR,
      SUBROUTINE SWTABP (RTYPE , OQI  , IVTYP, PSNAME, MIP, VOQR,         40.31
     &                   VOQ, IONOD)                                      40.51
!                                                                      *
!***********************************************************************
...
!
      ...
      USE OUTP_DATA                                                       40.13
      USE M_PARALL                                                        40.31
!NCF      USE swn_outnc, only: swn_outnc_spec                                 41.40
!PUN      USE SIZES, ONLY: MYPROC, MNPROC
...
!
      ...
      REAL      OQR(2), VOQ(MIP,*), AC2(MDC,MSC,MCGRD),
...
!
!NCF      FILENM = OUTP_FILES(OQI(2))                                         41.40
!NCF      NCF = INDEX( FILENM, '.NC' ).NE.0 .OR.                              41.40
!NCF     &      INDEX (FILENM, '.nc' ).NE.0                                   41.40
!NCF!
...
!MatL4               J = (N-1)*NCOLS + M
!MatL4            END IF
!MatL4            IF (RDATA(J).EQ.DUMVAL ) THEN
